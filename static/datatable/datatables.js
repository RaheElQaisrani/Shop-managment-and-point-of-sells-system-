 ...
 *   https://datatables.net/download/#dt/dt-1.13.4/af-2.5.3/b-2.3.6/b-print-2.3.6/date-1.4.1
 *
 * Included libraries:
 *   DataTables 1.13.4, AutoFill 2.5.3, Buttons 2.3.6, Print view 2.3.6, DateTime 1.4.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.4/af-2.5.3/b-2.3.6/b-print-2.3.6/date-1.4.1",
